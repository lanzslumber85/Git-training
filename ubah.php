<?php
  ...
  $resultQuery = query("SELECT * FROM mahasiswa WHERE id=$id");
  ...
  if (isset($_POST["submit"])) {
    ...
    $resultQuery = query("UPDATE mahasiswa SET nrp = '$nrp', nama = '$nama', email = '$email', jurusan = '$jurusan', gambar = '$gambar' WHERE id = $id");
